...
export const waifuTags = {
  ...
  hr: { tag: 'Wild Defense', category: 'Defense', short: 'hr', effect: '', desc: 'Hails from a harsh climate.', color: 'bg-gradient-to-t to-blue-300 from-gray-100 text-black' },
  ...
  mt: { tag: 'Creature Defense', category: 'Defense', short: 'mt', effect: '', desc: 'Is known as a monster-tamer or otherwise being good with animals.', color: 'bg-gradient-to-t to-red-600 from-gray-100 text-black' },
  cl: { tag: 'Stress Defense', category: 'Defense', short: 'cl', effect: '', desc: 'Is known for keeping a cool head or having great willpower.', color: 'bg-[#72c7cd] text-black' },
  ...
  id: { tag: 'Fatality Defense', category: 'Defense', short: 'id', effect: '', desc: 'Is known for inflicting instant death or not dying even when killed.', color: 'bg-gradient-to-r to-green-500 from-dark-500' },
  pl: { tag: 'Polymorph Defense', category: 'Defense', short: 'pl', effect: '', desc: 'Is known for polymorphing others.', color: 'bg-[#464d6d]' },
  ur: { tag: 'Wyldscape Defense', category: 'Defense', short: 'ur', effect: '', desc: 'Hails from a region where the local reality is unstable.', color: 'bg-gradient-to-r to-dark-300 via-purple-700 from-dark-300' },
  cr: { tag: 'Corruption Defense', category: 'Defense', short: 'cr', effect: '', desc: 'Is known for forcibly bringing out others’ dark sides.', color: 'bg-gradient-to-r to-dark-900 from-gray-500' },
  ...
  di: { tag: 'Trace Defense', category: 'Defense', short: 'di', effect: '', desc: 'Is known for using divination or other non-technological remote viewing.', color: 'bg-gradient-to-r to-blue-200 via-white from-blue-200 text-black' },
  fm: { tag: 'Destiny Defense', category: 'Defense', short: 'fm', effect: '', desc: 'Is known as a fate- or luck-manipulator.', color: 'bg-gradient-to-t to-red-900 via-red-500 from-red-900' },
  tm: { tag: 'Paradox Defense', category: 'Defense', short: 'tm', effect: '', desc: 'Is known as a time-manipulator.', color: 'bg-gradient-to-t to-blue-900 via-blue-400 from-blue-900' },
