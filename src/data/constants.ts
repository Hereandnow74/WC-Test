...
export const waifuTags = {
  ...
  st: { tag: 'Body Defense', category: 'Defense', short: 'st', effect: '', desc: 'Is known for working with diseases, chemical medicine, or poisons.', color: 'bg-[#612e13]' },
  ...
  hz: { tag: 'Environmental Defense', category: 'Defense', short: 'hz', effect: '', desc: 'Can ignore hazardous environments.', style: { background: 'linear-gradient(0deg, rgba(79,123,2,1) 0%, rgba(163,255,0,1) 70%)', color: '#000' } },
  mt: { tag: 'Creature Defense', category: 'Defense', short: 'mt', effect: '', desc: 'Is known as a monster-tamer or otherwise being good with animals.', style: { 'background-image': 'url("https://i.imgur.com/pSN5gOXm.png")', 'background-size': 'cover', 'color': '#000', 'font-weight': '600', 'border': '1px solid #777' } },
  cl: { tag: 'Stress Defense', category: 'Defense', short: 'cl', effect: '', desc: 'Is known for keeping a cool head or having great willpower.', style: { 'background-image': 'url("https://i.imgur.com/gDUGBdum.png")', 'background-size': 'cover', 'color': '#000', 'font-weight': '600', 'border': '1px solid #777' } },
  ml: { tag: 'Addiction Defense', category: 'Defense', short: 'ml', effect: '', desc: 'Is known for having a material vice.', color: 'bg-[#4a8108]' },
  ps: { tag: 'Mind Defense', category: 'Defense', short: 'ps', effect: '', desc: 'Is known as a psychic or mind-manipulator.', style: { 'background-image': 'url("/img/defenseBack.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  bj: { tag: 'Possession Defense', category: 'Defense', short: 'bj', effect: '', desc: 'Is known for bodyjacking others.', color: 'bg-[#631900]' },
  dr: { tag: 'Soul Defense', category: 'Defense', short: 'dr', effect: '', desc: 'Can drain or feed on life, mana, or souls.', color: 'bg-gradient-to-r to-red-500 from-blue-500' },
  id: { tag: 'Fatality Defense', category: 'Defense', short: 'id', effect: '', desc: 'Is known for inflicting instant death or not dying even when killed.', style: { 'background-image': 'url("https://i.imgur.com/zn4Ll9Sm.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  pl: { tag: 'Polymorph Defense', category: 'Defense', short: 'pl', effect: '', desc: 'Is known for polymorphing others.', color: 'bg-[#464d6d]' },
  ...
  cr: { tag: 'Corruption Defense', category: 'Defense', short: 'cr', effect: '', desc: 'Is known for forcibly bringing out others’ dark sides.', style: { 'background-image': 'url("https://i.imgur.com/V4NuMiHm.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  sc: { tag: 'Information Defense', category: 'Defense', short: 'sc', effect: '', desc: 'Is known for their ability to read or sense people.', color: 'bg-[#f9ca94] text-black' },
  di: { tag: 'Trace Defense', category: 'Defense', short: 'di', effect: '', desc: 'Is known for using divination or other non-technological remote viewing.', style: { 'background-image': 'url("https://i.imgur.com/ImuTdsPm.png")', 'background-size': 'cover', 'color': '#000', 'font-weight': '600', 'border': '1px solid #777' } },
  fm: { tag: 'Destiny Defense', category: 'Defense', short: 'fm', effect: '', desc: 'Is known as a fate- or luck-manipulator.', style: { 'background-image': 'url("https://i.imgur.com/6dTGTBQm.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  tm: { tag: 'Paradox Defense', category: 'Defense', short: 'tm', effect: '', desc: 'Is known as a time-manipulator.', style: { 'background-image': 'url("https://i.imgur.com/qDdxPu7m.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  ...
  tn: { tag: 'Time Manipulation', category: 'Powers', short: 'tn', effect: '', desc: 'Is known as a time-manipulator.', color: 'bg-gradient-to-t to-blue-900 via-blue-400 from-blue-900' },
  ...
  an: { tag: 'Angel', category: 'Race', short: 'an', effect: '', desc: '', color: 'bg-[#ffffff] text-black' },
  ...
  dh: { tag: 'Demi-human', category: 'Race', short: 'dh', effect: '', desc: '', color: 'bg-[#8d4127]' },
  md: { tag: 'Maid', category: 'Occupation', short: 'md', effect: '', desc: '', color: 'bg-gradient-to-t to-gray-400 from-black' },
  en: { tag: 'Engineer', category: 'Occupation', short: 'en', effect: '', desc: '', color: 'bg-[#676767]' },
  sn: { tag: 'Scientist', category: 'Occupation', short: 'sn', effect: '', desc: '', color: 'bg-[#2b548d]' },
  ...
  me: { tag: 'Mage', category: 'Powers', short: 'me', effect: '', desc: '', color: 'bg-teal-500 text-black' },
  cf: { tag: 'Chef', category: 'Occupation', short: 'cf', effect: '', desc: '', color: 'bg-[#dd8812]' },
  ...
  ad: { tag: 'Android', category: 'Race', short: 'ad', effect: '', desc: '', color: 'bg-gradient-to-t to-gray-400 from-gray-200 text-black' },
  cb: { tag: 'Cyborg', category: 'Race', short: 'cb', effect: '', desc: '', style: { background: 'linear-gradient(90deg, rgba(238,202,178,1) 0%, rgba(168,168,168,1) 100%)', color: '#000' } },
  ...
  pc: { tag: 'Princess', category: 'Occupation', short: 'pc', effect: '', desc: '', color: 'bg-[#dd12db]' },
  az: { tag: 'Amazon', category: 'Race', short: 'az', effect: '', desc: 'See Warranty Plan for qualifiers', color: 'bg-[#fdb978] text-black' },
  de: { tag: 'Demigod', category: 'Race', short: 'de', effect: '', desc: '', style: { background: 'linear-gradient(0deg, rgba(255,255,255,1) 0%, rgba(255,192,0,1) 70%)', color: '#000' } },
  ...
  ct: { tag: 'Catgirl', category: 'Race', short: 'ct', effect: '', desc: '', style: { background: 'linear-gradient(0deg, rgba(215,138,12,1) 20%, rgba(240,240,240,1) 100%)', color: '#000' } },
  ...
  pt: { tag: 'Priest', category: 'Occupation', short: 'pt', effect: '', desc: '', color: 'bg-[#ffffff] text-black' },
  ...
  al: { tag: 'Alien', category: 'Race', short: 'al', effect: '', desc: '', style: { background: 'linear-gradient(90deg, rgba(12,94,243,1) 0%, rgba(5,227,31,1) 100%)', color: '#fff' } },
  mg: { tag: 'Monster-girl', category: 'Race', short: 'mg', effect: '', desc: '', style: { background: 'linear-gradient(0deg, rgba(255,62,169,1) 0%, rgba(74,129,255,1) 100%)', color: '#fff' } },
  ...
  sy: { tag: 'Symbiote Theme', category: 'Utility', short: 'sy', effect: '', desc: 'Will qualify you to recieve specific symbiote theme', style: { background: 'linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(129,129,129,1) 50%, rgba(0,0,0,1) 100%)', color: '#fff' } },
  ...
  ha: { tag: 'Hacker', category: 'Occupation', short: 'ha', effect: '', desc: '', style: { background: 'linear-gradient(0deg, rgba(71,107,77,1) 0%, rgba(0,255,29,1) 70%)', color: '#000' } },
  ...
  cu: { tag: 'Cultivator', category: 'Occupation', short: 'cu', effect: '', desc: '', style: { background: 'radial-gradient(circle, rgba(251,148,63,1) 0%, rgba(255,248,0,1) 100%)', color: '#000' } },
  sh: { tag: 'Stealth', category: 'Powers', short: 'sh', effect: '', desc: 'Has experience sneaking around or committing hidden actions.', color: 'bg-teal-500 text-black' },
  pm: { tag: 'Power Manipulation', category: 'Powers', short: 'pm', effect: '', desc: 'Is known to control, alter, or manipulate powers and abilities in any way or form', color: 'bg-teal-500 text-black' },

  te: { tag: 'Tsundere', category: 'Personality', short: 'te', effect: '', desc: 'A cute, friendly flufball underneath all those cold glares and angry shouting', color: 'bg-teal-500 text-black' },
  ke: { tag: 'Kuudere', category: 'Personality', short: 'ke', effect: '', desc: 'Cold appearance and personality to all but those they love most.', color: 'bg-teal-500 text-black' },
  ye: { tag: 'Yandere', category: 'Personality', short: 'ye', effect: '', desc: 'Obsessive and possessive when it comes to crushes. Careful or they might get violent.', color: 'bg-teal-500 text-black' },
  ...
  gi: { tag: 'Genki', category: 'Personality', short: 'gi', effect: '', desc: 'Characters who are lively, energetic and almost uncotrollable', color: 'bg-teal-500 text-black' },
  ge: { tag: 'Generic', category: 'Utility', short: 'ge', effect: '', desc: 'For generic entries like pokemons, MGE monster girls, etc.', color: 'bg-teal-500 text-black' },
  nc: { tag: 'Necromancer', category: 'Occupation', short: 'nc', effect: '', desc: 'Is able to reanimate but not technically ressurect the dead', color: 'bg-teal-500 text-black' },
  cs: { tag: 'Custom', category: 'Utility', short: 'cs', effect: '', desc: 'This character looks and gender can be customized at a purchase. (Ussualy RPG protagonists)', color: 'bg-teal-500 text-black' },
