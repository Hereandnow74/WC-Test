...
export const waifuTags = {
  ...
  O: { tag: 'Other', short: 'O', effect: '', desc: 'Genderless or someone in between male and female.', color: 'bg-fuchsia-700' },
  ...
  th: { tag: 'Transhuman', short: 'th', effect: '', desc: 'Strives to surpass his current limitations and achieve transcendence', style: { background: 'linear-gradient(0deg, rgba(167,0,255,1) 0%, rgba(28,0,245,1) 100%)', color: '#fff' } },
  ...
  mu: { tag: 'Mutant', short: 'mu', effect: '', desc: 'A character biologically different from the majority of his species in his world', color: 'bg-[#315be5]' },
  ...
  un: { tag: 'Undead', short: 'un', effect: '', desc: 'A being technically dead but still animate', color: 'bg-[#2c5332]' },
  ...
  az: { tag: 'Amazon', short: 'az', effect: '', desc: 'See Warranty Plan for qualifiers', color: 'bg-[#fdb978] text-black' },
  ...
  sa: { tag: 'Strategist', short: 'sa', effect: '', desc: 'Has experience in laying plans and developing strategies or tactics', style: { background: 'linear-gradient(0deg, rgba(34,193,195,1) 0%, rgba(0,163,255,1) 80%)', color: '#fff' } },
  ...
  rg: { tag: 'Regenerator', short: 'rg', effect: '', desc: 'Is able to subconsciously heal himself from wounds and injuries', style: { background: 'linear-gradient(0deg, rgba(149,4,48,1) 0%, rgba(255,0,77,1) 100%)', color: '#000' } },
  pr: { tag: 'Protagonist', short: 'pr', effect: '', desc: 'The leading character(s) in a world', style: { background: 'linear-gradient(0deg, rgba(245,70,0,1) 0%, rgba(243,233,0,1) 70%)', color: '#000' } },
  ...
  rw: { tag: 'Reality Warper', short: 'rw', effect: '', desc: 'Is able to manipulate, change or alter reality in any way shape or form', style: { background: 'linear-gradient(90deg, rgba(132,4,185,1) 0%, rgba(255,15,153,1) 50%, rgba(132,4,185,1) 100%)', color: '#fff' } },
  ...
  pm: { tag: 'Power Manipulation', short: 'pm', effect: '', desc: 'Is known to control, alter, or manipulate powers and abilities in any way or form', color: 'bg-teal-500 text-black' },

  te: { tag: 'Tsundere', short: 'te', effect: '', desc: 'A cute, friendly flufball underneath all those cold glares and angry shouting', color: 'bg-teal-500 text-black' },
  ke: { tag: 'Kuudere', short: 'ke', effect: '', desc: 'Cold appearance and personality to all but those they love most.', color: 'bg-teal-500 text-black' },
  ye: { tag: 'Yandere', short: 'ye', effect: '', desc: 'Obsessive and possessive when it comes to crushes. Careful or they might get violent.', color: 'bg-teal-500 text-black' },
  os: { tag: 'Onee-san', short: 'os', effect: '', desc: 'Personality type that always takes care of others', color: 'bg-teal-500 text-black' },
  ci: { tag: 'Chuuni', short: 'ci', effect: '', desc: 'Early teens who have grandiose delusions and desperately want to stand out, convincing themselves they have hidden knowledge or secret powers', color: 'bg-teal-500 text-black' },
  gi: { tag: 'Genki', short: 'gi', effect: '', desc: 'Characters who are lively, energetic and almost uncotrollable', color: 'bg-teal-500 text-black' },
  ge: { tag: 'Generic', short: 'ge', effect: '', desc: 'For generic entries like pokemons, MGE monster girls, etc.', color: 'bg-teal-500 text-black' },
  nc: { tag: 'Necromancer', short: 'nc', effect: '', desc: 'Is able to reanimate but not technically ressurect the dead', color: 'bg-teal-500 text-black' },
  ...
  sg: { tag: 'Ship-girl', short: 'sg', effect: '', desc: 'Female Waifu featuring design elements of a ride/anthropomorphization of a ride', color: 'bg-teal-500 text-black' },
