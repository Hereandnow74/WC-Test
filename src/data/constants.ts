...
export const waifuTags = {
  ...
  st: { tag: 'Body Defense', category: 'Defense', short: 'st', effect: '', desc: 'Is known for working with diseases, chemical medicine, or poisons.', style: { 'background-image': 'url("https://i.imgur.com/yjUZyU0m.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  ...
  ml: { tag: 'Addiction Defense', category: 'Defense', short: 'ml', effect: '', desc: 'Is known for having a material vice.', style: { 'background-image': 'url("https://i.imgur.com/BR5FZgEm.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  ...
  bj: { tag: 'Possession Defense', category: 'Defense', short: 'bj', effect: '', desc: 'Is known for bodyjacking others.', style: { 'background-image': 'url("https://i.imgur.com/30QzIimm.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  ...
  pl: { tag: 'Polymorph Defense', category: 'Defense', short: 'pl', effect: '', desc: 'Is known for polymorphing others.', style: { 'background-image': 'url("https://i.imgur.com/krRzC16m.png")', 'background-size': 'cover', 'color': '#fff', 'font-weight': '600', 'border': '1px solid #777' } },
  ...
  sc: { tag: 'Information Defense', category: 'Defense', short: 'sc', effect: '', desc: 'Is known for their ability to read or sense people.', style: { 'background-image': 'url("https://i.imgur.com/GXc7ovSm.png")', 'background-size': 'cover', 'color': '#000', 'font-weight': '600', 'border': '1px solid #777' } },
  ...
  en: { tag: 'Engineer', category: 'Occupation', short: 'en', effect: '', desc: 'A being who specializes in practical applications of science, often also a Scientist.', color: 'bg-[#676767]' },
  sn: { tag: 'Scientist', category: 'Occupation', short: 'sn', effect: '', desc: 'A being who is known for relying on hypothesizing, testing, and forming conclusions from their testing to understand the world.', color: 'bg-[#2b548d]' },
