...
export const waifuTags = {
  ...
  fw: { tag: 'Fanwork', category: 'Utility', short: 'fw', effect: '', desc: 'From an established fan creation.', style: { background: 'linear-gradient(0deg, rgba(34,193,195,1) 0%, rgba(219,255,0,1) 80%)', color: '#000' } },
  ...
  cu: { tag: 'Cultivator', category: 'Occupation', short: 'cu', effect: '', desc: 'Seeks to reach the pinnacle of their discipline, usually of Eastern-influenced origin. Almost always qualifies for Transhuman.', style: { background: 'radial-gradient(circle, rgba(251,148,63,1) 0%, rgba(255,248,0,1) 100%)', color: '#000' } },
