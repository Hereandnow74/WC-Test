...
export const waifuTags = {
  ...
  me: { tag: 'Mage', category: 'Powers', short: 'me', effect: '', desc: 'A being who is experienced in the magical arts.', style: { background: 'linear-gradient(0deg, rgba(60,75,189,1) 0%, rgba(1,18,183,1) 100%)', color: '#fff' } },
  ...
  nc: { tag: 'Necromancer', category: 'Occupation', short: 'nc', effect: '', desc: 'Is able to reanimate but not technically ressurect the dead', style: { background: 'linear-gradient(90deg, rgba(10,23,13,1) 0%, rgba(48,109,63,1) 50%, rgba(10,23,13,1) 100%)', color: '#fff' } },
  cs: { tag: 'Custom', category: 'Utility', short: 'cs', effect: '', desc: 'This character looks and gender can be customized at a purchase. (Ussualy RPG protagonists)', color: 'bg-[#7656de] text-white' },
