...
<p>For safety reasons, all purchased companions, followers, and familiars are bound with one of the Stamp’s tattoos before delivery, unless you opt out of having any bindings. You can have no more than one binding method at any time. Perks listed as Other Capture Methods are not bindings, and are thus compatible with each other and all bindings. When you buy a new binding method, your previous one will be automatically refunded and disappear from existence. Any physical or mental effects that the former binding actively maintained will fade over the next few days. Long-term “set and forget” effects, such as from Tempest Jewelry, the Hypnosis App, or Tantric Arts, will remain in their current state.
</p>
<p>All of your subjects have a dormant, invisible tattoo, to mark them as yours and act as a conduit for the appropriate level of general binding rules, as determined by your intensity choices and the individual’s status in your retinue. Dormant tattoos turn active when Canvas is applied or you have the Stamp.</p>
`
...
<p>Once you’ve purchased this perk ten times, all new shroud-bound subjects will automatically receive an Element without any further purchases. Your ability to bind targets stronger than yourself is now more forgiving. Additionally, all new purchased subjects will be shroud-bound before delivery. This removes the failure chance for all purchases and consenting captures. If you buy ten copies of this perk in your starting build, this will apply to all subjects purchased at that time as well.</p>`,
  },
  {
    uid: 'CmH9Z',
