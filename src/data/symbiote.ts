...
<h3 class="text-lg font-semibold text-center">Alterzelu: Basic Larva</h3>
...
<p>Regardless of your chosen larva type, you will always begin with two full clutches of mature specimens, ready to bind your starting companions and followers, though the number of individuals per clutch varies wildly. In addition to their basic effects, the default binding tattoos will prevent your subjects from lethally harming any of your symbiote units, and they will usually accept the conversion outright if they know you want them to.</p>
