...
export const DLCwaifu_perks: WaifuPerk[] = [
  ...
  },
  {
    ...
    tier: 6,
    image: 'https://i.imgur.com/NoakcF4l.png',
    cost: 30,
    discount: 0,
    costT: 0,
    desc: 'Fjorm now clads herself in the ice goddess Nifl\'s power, wielding a fragment of the goddess herself in the form of her axe and armor. If you have both Fjorm and Nifl, this perk can be gained for free.',
    whitelist: [],
  },
]
