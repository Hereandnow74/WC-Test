...
waifu_perks.push({
  ...
  image: 'https://i.imgur.com/Iea8EN9.jpg',
  discount: 1,
  cost: 11111,
...
waifu_perks.push({
  ...
  from: 'Monogatari',
  image: 'https://i.imgur.com/AQ74QBy.jpg',
  discount: 20,
...
waifu_perks.push({
  ...
  waifu: 'Hakubi Washuu',
  from: 'Tenchi Muyo!',
  image: '/img/waifu_perks/choushin.jpg',
  discount: 1000,
  cost: 11111,
...
waifu_perks.push({
  ...
  waifu: 'Hakubi Ryouko',
  from: 'Tenchi Muyo!',
  image: '/img/waifu_perks/hawk_evo.jpg',
  discount: 200,
  cost: 11111,
...
waifu_perks.push({
  ...
  from: 'To Love-Ru',
  image: '/img/waifu_perks/darkness.jpg',
  cost: 950,
...
waifu_perks.push({
  ...
  from: 'Final Fantasy XIV',
  image: '/img/waifu_perks/mirror.jpg',
  cost: 48,
...
waifu_perks.push({
  ...
  waifu: 'Feo UI',
  from: 'Final Fantasy XIV',
  image: '/img/waifu_perks/live_queen.jpg',
  cost: 95,
...
waifu_perks.push({
  ...
  from: 'Final Fantasy XIV',
  image: '/img/waifu_perks/dancing_snow.jpg',
  discount: 40,
...
waifu_perks.push({
  ...
  waifu: 'Ryne',
  from: 'Final Fantasy XIV',
  image: '/img/waifu_perks/light_ice.jpg',
  cost: 80,
...
waifu_perks.push({
  ...
  from: 'Nasuverse',
  image: '/img/waifu_perks/bang.jpg',
  cost: 480,
...
waifu_perks.push({
  ...
  tier: 8,
  image: '/img/waifu_perks/eins.jpg',
  cost: 150,
...
waifu_perks.push({
  title: 'Uwasa Of Kamihama\'s Holy Maiden',
  waifu: 'Tomoe Mami ',
  from: 'Madoka Magica',
  tier: 8,
  image: '/img/waifu_perks/maiden.jpg',
  cost: 150,
...
waifu_perks.push({
  ...
  from: 'Sailor Moon',
  tier: 8,
  image: '/img/waifu_perks/moon.jpg',
  cost: 100,
