...
<p>If you have previously purchased Template Stacking for yourself or your retinue at ranks 0, 1, or 2, take a refund on all such copies of it that fall under this perk’s purview, according to your Transhuman type. You may not make additional purchases of those perks for abilities matching your Transhuman type. Additional potential within your Transhuman type will be acquired through this perk instead. OC Donut Steel may still be purchased, at half cost, for unique expressions of generic abilities that you have not yet gained through this perk, but the results will not manifest until you otherwise meet the conditions for gaining such a power through this perk. In that case, you’re paying for the ability to choose the power, not the power itself.</p> `,
})
