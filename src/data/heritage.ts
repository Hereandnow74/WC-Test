...
heritages.push({
  ...
  <p>Instead, by designating Shares of plundered booty to each crew member, the total value of all goods currently stored in the booty space, or as cargo aboard your ships and in Dominions, will be represented with increasingly grandiose changes along a set theme. This theme can take a number of forms depending on the Contractor or individual's preferences, but common ones include the manifestation of expensive jewelry, clothing becoming increasingly opulent, gilded piercings, intricate body art, and literal 'asset' expansion such as the breasts, thighs, and ass of women or the torso, muscles, and genitals of men.</p>
  <p>By default, these transformations will progress roughly evenly. Through the Booty Tracker app, you can program the focus and flow of these changes as desired to create delayed effects, surges, sudden shifts from one type of transformation to another, or other patterns.</p>
  <p>However, hoarding treasure is only the first half of the equation. As you accumulate booty, you can also declare Shore Leave any time you have access to a place of trade. This can take several forms, from traditional port towns to major cities, festivals, tourism hotspots, or black markets. Shore leave will see your crew temporarily disperse, with free access to their shares as liquid currency to spend. They are not required to spend all of their shares, and may retain some booty and the resulting transformations even after shore leave is over.</p>
  <p>During shore leave, your crew will partake in whatever amenities are available "in port" until your defined time limit or they run out of booty to spend. At the conclusion of shore leave, your crew's morale will see significant, if temporary, improvement. This morale increase can manifest in a number of ways, but in general crews with high morale are much more effective at both their roles and in overall performance, apart from (usually) being happier and more pleasant to be around. The effectiveness and duration of this morale increase relies on a variety of factors, including:
  <ul class="list-inside list-disc">
    <li>the length of declared shore leave,</li>
    <li>the amount of booty available to that individual crew member,</li>
    <li>the quality and variety of amenities available in your designated location,</li>
    <li>any personal time and attention spent among them during shore leave,</li>
    <li>and any relevant Talents or abilities.</li>
  </ul>
  A few-hour shopping spree of luxuries might see a small increase for a few days, a day-long trip to replace an entire wardrobe see a medium increase for a week, or a 72-hour bender of nonstop drugs, sex, alcohol, and luxury a major buff for a month, and so on.
  </p>
  <p>There is an innate rubberbanding effect here. While it's expected that some members of the crew will receive more shares than others, all the crew will expect some payout for their time and effort. If the vast majority of the booty is concentrated in your favorites, they will see noticeably less effect than if it is at least somewhat spread through the crew. However, your entire crew will also see an increase in loyalty based on the overall potency of the buff, as the lower-ranking members of the crew see what they might earn with greater service. This is especially effective at motivating non-retinue crew members.</p>
  <p>As a final measure, you also gain the opportunity to declare Double Shifts, locking your crew into a high-performance state that increases both their base parameters and any existing shore leave buffs for the duration of a single encounter — which may be as short as a single fight or as long as a smuggling run from one port to another, with the buff becoming less effective the longer it goes on. However, you do so by promising increased shares to your entire crew coming out of your own share of the booty, as well as a break afterward — failing to pay up and declare shore leave the moment it becomes reasonable will result in a state of mutiny.</p>
  <p>During mutiny, your crew's discontent will fester and be expressed in a variety of ways depending on their personalities. This may manifest as booty being stolen from the stash, sexual aggression towards you or other retinue members (though never truly unwanted by you), an overall reduction in effectiveness via malicious compliance, desertion, and other irritants. Deserters who are not part of your retinue are usually gone for good, but those who are will eventually return, after they run out of funds to support their unauthorized leave. Additionally, entering mutiny will permanently reduce the effectiveness of future double shifts until you have demonstrated your ability to follow-through to your crew.</p>
  <p>Mutiny can be addressed in a variety of ways, whether through mundane means (demonstrations of physical power are classic), sexual means (correction 💢💢💢 is always effective), Lures, third-party abilities, or a satisfying shore leave. Corrected 💢💢💢 crew, by any means, are more effective in their roles than mutinous and even satisfied crew, but this status will only last for two weeks (336 hours). If the base conditions for mutiny are not resolved in that time - e.g. delivering on a promise of leave - the mutineers will relapse and require further correction 💢💢💢.</p>
  `,
})
heritages.push({
  uid: 's4dWc',
...
heritages.push({
  ...
  <p>Once you have a Safe Haven, you may store excess booty within or near the Safe Haven. Booty stored in this fashion does not transform you or your crew via Bling, Booty, and Chests. Additionally, shore leave is extra effective at influencing the area around you, as your crew spends wildly and gleefully, showcasing to all around the benefits of your lifestyle. Any deserters who spend time in a Safe Haven will also drift back to your crew more quickly and assuredly.</p>
  `,
})
heritages.push({
  uid: 's4dWj',
