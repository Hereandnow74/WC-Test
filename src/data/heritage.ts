...
<p><b>Biomorph</b>: Anyone you impregnate has the core of a Stamp mark appear over their womb, which finishes developing over the course of the pregnancy. Additionally, should you possess Potpourri, you may now directly affect emotions with your pheromones. Your fluids are also saturated with them. You are able to encourage the specific emotional responses or feelings of those nearby, provided they breathe the same air as you. Your fluids have a similar effect and can work via contact.</p>
...
<p><b>Aethermorph</b>: Take a second copy of Soul Defense for free, due to the concentrated - lifeforce base of the Aethermorph Essence Core. You are able to substitute for the power requirements of any ritual, spell, or magical artifact, though not more specific key components unrelated to power requirements.</p>`,
})
