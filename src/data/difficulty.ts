...
export const difficultyOptions = [
  ...
  },
  {
    ...
    intensity: 2,
    desc: 'In addition to the effects of Only Followers, none of the mental effects described in General Binding Rules will apply to your subjects. You may still use other means to win or compel your subjects’ trust, obedience, and willingness to participate in the captures of their friends and loved ones.',
    category: 'difficulty',
    type: 'binding',
  },
  {
  ...
  },
  {
    ...
    intensity: 3,
    desc: 'Your account is removed from R.I.P. eligibility. Should you ever die in a way that triggers R.I.P. rules, you will permanently lose your contractor status and all company perks and functions. If you also have Only Followers or higher, an Executor will have no purpose and you may not choose one.',
    category: 'difficulty',
    type: 'death',
  },
  {
