...
origin.push({
  ...
  character: true,
  max: 20,
  desc: `You reincarnate into a canon character from your starting world, whether that’s a waifu or husbando, at a time when they’re alive. You will be them, for all intents and purposes, with your original memories adding to theirs at some point before the start of your story, but not before the equivalent of 13 human years old. You can distinguish between the two sets of memories without difficulty. Rule 63 variants of substitution targets require Universal Calibration I, unless the target is androgynous or customizable. If the target is part of a set that are purchased together, choose one to insert into and take the others as free retinue members. If the target has any number of personal familiars, take them as free retinue members as well.
  <p>You will keep all of your substitution target’s skills, powers, and special traits, as they were at the point of substitution. All adjustments described in Basic Rules: Purchases will still apply to your substitution choice.</p>
