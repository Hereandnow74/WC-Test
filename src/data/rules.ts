...
export const effectiveTiers = `<h3 class="font-bold">Effective Tiers</h3>
  ...
  <p>Many individuals’ powers rely on henshin devices, familiars, or special equipment that they can be easily separated from and reduced to, usually, only T1-T3. These items are accounted for in their listed tiers, but not included in their effective tier calculations until step 3.</p>`
...
<p>If you only wanted a capture for their credit value, you may ship them to us at the company. We’ll pay you a certain fraction of the purchase price of their effective tier at step 3, rising with your Intensity and then rounded down to the next full credit. This applies regardless of whether step 1a or step 3 has the higher value. Humanoid familiars gained for free from an Origin choice will not count for capture credits, but may still be sold at the normal rate. As with captures, payouts for sales are not granted for local versions of targets that you’ve purchased or alternate versions that you’ve already sold once, unless they’re a unique entry in the lists proper or as a waifu perk. Extras have no additional sale value.</p>
...
<p>In the event that something so unfortunate happens as your death, your retinue will have three days (72 hours) to revive you before they gain their freedom. During this period, the functions on your smart device that are normally limited to just you are now available to every retinue member who isn’t a familiar. This includes loans. A special list will also appear in the shopping app that features every waifu capable of resurrection.</p>
<p>This ruleset will not trigger if you have an automatic resurrection system in place for yourself, even if that process takes longer than 72 hours. Pre-planned resurrections will also not trigger this rule, unless and until the plan fails to a point where it can no longer be salvaged. If the local world has a “playable” afterlife, that interacts regularly with the mortal and other planes, this ruleset will not trigger until your soul body is destroyed. Additionally, treat your soul body as your regular body for the purposes of Drain and Fatality Defenses.</p>
<p>Freed retinue members will retain any waifu perks applied to them, shared Heritage perks, the results of cross-training beyond their canon abilities... everything up to step 3 on the effective tier calculations. Any retinue member or purchased or registered Catch-a-Ride vehicle that is still inside your former Demiplane or Dungeon will be ejected into the last world they, personally, visited, as the pocket dimension ceases to exist.</p>
`
...
<p>Children of your Extra or Substitute target that you capture are counted as descendants, even if they were already born when you took over. Capture credits are not awarded, however, for any descendant of yours, who was born or even conceived after your entrance, or anyone born into your retinue.</p>
