<template>
  ...
  >
    <h3 class="relative text-xl flex flex-wrap justify-center items-center px-4">
      <span class="whitespace-nowrap">{{ perk.title }} ({{ countVal }}x)</span>
      ...
      <span text="gray-500 dark:gray-400" class="whitespace-nowrap">
        (Cost: <span text="green-600 dark:green-300">{{ perk.cost * countVal || perk.cost }}</span>)
      </span>
      <bi:check-lg
        v-if="isActive"
